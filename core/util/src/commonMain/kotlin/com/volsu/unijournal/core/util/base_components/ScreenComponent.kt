package com.volsu.unijournal.core.util.base_components
...
import com.volsu.unijournal.core.util.local.findVolsuException
...
abstract class ScreenComponent<State : BaseState,in Event : BaseEvents>(
    ...
    protected open fun onCaught(throwable: Throwable) {
        SnackFlow.show(SnackState.failure(throwable.findVolsuException().message))
    }
